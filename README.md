...
## 🥕 CarrotCam — Phone as Wireless Webcam

> Turn your Android phone into a wireless webcam for your PC. No drivers. No cables.

**Features:** MJPEG streaming · Virtual Camera (Zoom/Discord/OBS) · MP4 Recording · Screenshots · Discord Rich Presence · Auto-update

**Stack:** `C++` `Qt 6` `FFmpeg` `DirectShow` `Android NDK`

<div align="center">

[![Latest Release](https://img.shields.io/github/v/release/DG-925/CarrotCam?style=for-the-badge&color=22c55e)](https://github.com/DG-925/CarrotCam/releases/latest)
...
## 🌐 LogicLegends — Portfolio & Commission Platform

> Full-stack platform for showcasing work and managing commissions.

**Stack:** `Next.js` `React` `MongoDB` `TailwindCSS` `Vercel`

<div align="center">

[![Visit Site](https://img.shields.io/badge/%F0%9F%8C%90_Visit_LogicLegends.dev-FF5722?style=for-the-badge)](https://logiclegends.dev/)
...
Open-source [Vencord](https://github.com/Vendicated/Vencord) plugins — install from within Vencord's plugin browser.

| Plugin | What it does |
|:-------|:-------------|
| 🌫️ **[Quick-Blur](https://github.com/DG-925/Quick-Blur)** | Hotkey-triggered full Discord window blur — one keypress to go incognito |
| ⌨️ **[Mechanical-Keyboard-Sounds](https://github.com/DG-925/Mechanical-Keyboard-Sounds)** | Satisfying mech keyboard sounds while you type in Discord |
| 😂 **[RandomEmojiTyper](https://github.com/DG-925/RandomEmojiTyper)** | Appends a random emoji to every message sent — pure chaos |
...
|:--------|:-----------|:------|
| ❌ [**Tic Tac Toe**](https://github.com/DG-925/Tic-Tac-Toe) | Desktop XO game vs AI — 3 difficulties | `Python` `pywebview` `HTML/CSS/JS` |
| 🔧 [**Steam Desktop Icon Fixer**](https://github.com/DG-925/Steam-Desktop-Icon-Fixer) | Auto-repairs broken Steam icons post-reinstall | `Python` |
| 🔌 [**PortManager**](https://github.com/DG-925/PortManager) | Network port management utility | `C#` |
...
![GitHub Stats](https://github-readme-stats-anuraghazra1.vercel.app/api?username=DG-925&show_icons=true&theme=radical&hide_border=true&bg_color=0D1117&title_color=FF5722&icon_color=FF9800&text_color=FFFFFF&ring_color=FF5722&include_all_commits=true)

![Top Languages](https://github-readme-stats-anuraghazra1.vercel.app/api/top-langs/?username=DG-925&layout=compact&theme=radical&hide_border=true&bg_color=0D1117&title_color=FF5722&text_color=FFFFFF&langs_count=8)
...
![Snake](https://raw.githubusercontent.com/DG-925/DG-925/output/github-snake-dark.svg)
...
![Profile Views](https://komarev.com/ghpvc/?username=DG-925&style=for-the-badge&color=FF5722&label=PROFILE+VIEWS)
